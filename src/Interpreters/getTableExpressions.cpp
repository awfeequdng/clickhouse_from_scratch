    ...
    NamesAndTypesList & virtuals)
{
    ...
    if (table_expression.subquery)
    {
        std::cout << "not implemented yet: table_expression.subquery" << std::endl;
        exit(0);
    ...
    {
        std::cout << "not implemented yet: table_expression.table_function" << std::endl;
        exit(0);
    ...
    {
        std::cout << "not implemented yet: table_expression.database_and_table_name" << std::endl;
        exit(0);
