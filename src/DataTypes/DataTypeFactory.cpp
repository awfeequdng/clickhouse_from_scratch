...
DataTypePtr DataTypeFactory::get(const String & full_name) const
{
    ...
    // return get(ast);
    std::cout << "DataTypeFactory::get(const String & full_name): not implemented yet." << std::endl;
    return nullptr;
}
...
DataTypePtr DataTypeFactory::get(const String & family_name_param, const ASTPtr & parameters) const
{
    ...
    std::cout << "DataTypeFactory::get(const String & family_name_param, const ASTPtr & parameters): not implemented yet." << std::endl;
