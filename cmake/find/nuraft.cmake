...
set(ENABLE_NURAFT ${ENABLE_LIBRARIES})

if (NOT ENABLE_NURAFT)
    return()
endif()

if (NOT EXISTS "${PROJECT_SOURCE_DIR}/contrib/NuRaft/CMakeLists.txt")
...
if (NOT OS_FREEBSD)
    ...
    set (NURAFT_INCLUDE_DIR "${PROJECT_SOURCE_DIR}/contrib/NuRaft/include")
